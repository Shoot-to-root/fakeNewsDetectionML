...
Problem Definition
A news article is considered fake regarding the definition proposed by Claire Wardle in [Fake news. It's complicated. Retrieved from https://firstdraftnews.org/fake-news-complicated/] and aim to differentiate the veracity of an article by a content-based approach. The “content” refers to the text of the article. The investigation of other types of content such as audio, image, video, etc. is reserved for future work.
...
The application is hosted on sushi.pythonanywhere.com. Feel free to try it out!
